...
// 2. encodeURI: URL파라미터를 encoding 한다. url 전체를 encoding 해야 하는 경우 사용(o)
var url3 = encodeURI(url);
console.log(url3);

// 3. encodeURIComponent: 값만 Encoding 해야 하는 경우, url 전체를 encoding 해야 하는 경우 사용(x) 값만 사용해야 하는 경우(o)
