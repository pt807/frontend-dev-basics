...
console.log(
  `${studentName}의 성적 국어: ${korean} 수학: ${math} 과학: ${science} 음악: ${music}`
);

// ex05
const averageScore = function ({
  name: studentName,
  score: { math = 0, korean = 0, science = 0 },
}) {
  console.log(
...
// ex10 - 배열의 구조분해: ... array spread operator 함수의 파라미터로 사용하기(argument 대용)
const rainbow = [
  "red",
  "orange",
  "yellow",
